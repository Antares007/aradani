...
S(reject ) { R(p_t*, cο); R(p_t*, pο); Α(god, cο, got, pο, 2, os_queue_and) O; }
S(forward) { R(p_t*, pο); Α(god, pο, os_queue) O; }
S(greet  ) { R(p_t*, cο); R(p_t*, pο); Α(god, cο, gor, pο, 2, os_queue_and) O; }
